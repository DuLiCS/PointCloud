% 设置输入文件
input_file = 'B7.txt';   % 替换成你的文件名

% 读取点云
data_all = readmatrix(input_file);  % 自动识别空格或制表符
datas = data_all(:, 1:3);           % 只取前三列 X Y Z

% 如果想保留颜色:
colors = data_all(:, 4:6);          % 第4-6列 R G B
...
[data]=save_data(data_new(:,1:3),'/Users/duli/CS/Project/little Project/20250902','data_new.txt');
%  data_out123=data_new*RR2*R2;
...
[data_new1,buliao_out_x1]=tianbu_guocheng(data_new,[1 0 0],'x1',5,0);

[data_new2,buliao_out_x2]=tianbu_guocheng(data_new1,[-1 0 0],'x2',5,0);

[data_new3,buliao_out_y1]=tianbu_guocheng(data_new2,[0 1 0],'y1',5,0);

[data_new4,buliao_out_y2]=tianbu_guocheng(data_new3,[0 -1 0],'y2',5,0);

[data_new5,buliao_out_z1]=tianbu_guocheng(data_new4,[0 0 1],'z1',5,0);

[data_new6,buliao_out_z2]=tianbu_guocheng(data_new5,[0 0 -1],'z2',5,0);
...
% dataf=[datas;data_final;data_final_1];
 [data]=save_data(data_out(:,1:3),'/Users/duli/CS/Project/little Project/20250902','data_final.txt');
